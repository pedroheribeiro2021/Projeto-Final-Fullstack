...
export class resetPass1682366375398 implements MigrationInterface {
    name = 'resetPass1682366375398'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(100) NOT NULL, "email" varchar(100) NOT NULL, "password" varchar(100) NOT NULL, "reset_token" varchar, "cpf" varchar(11) NOT NULL, "cellPhone" varchar(12) NOT NULL, "birthday" varchar(8) NOT NULL, "description" varchar(255), "is_advertiser" boolean NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "addressId" varchar, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_users" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(100) NOT NULL, "email" varchar(100) NOT NULL, "password" varchar(100) NOT NULL, "reset_token" varchar, "cpf" varchar(11) NOT NULL, "cellPhone" varchar(12) NOT NULL, "birthday" varchar(8) NOT NULL, "description" varchar(255), "is_advertiser" boolean NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "addressId" varchar, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "FK_bafb08f60d7857f4670c172a6ea" FOREIGN KEY ("addressId") REFERENCES "addresses" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_users"("id", "name", "email", "password", "reset_token", "cpf", "cellPhone", "birthday", "description", "is_advertiser", "createdAt", "updatedAt", "addressId") SELECT "id", "name", "email", "password", "reset_token", "cpf", "cellPhone", "birthday", "description", "is_advertiser", "createdAt", "updatedAt", "addressId" FROM "users"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`ALTER TABLE "temporary_users" RENAME TO "users"`);
        await queryRunner.query(`CREATE TABLE "temporary_images" ("id" varchar PRIMARY KEY NOT NULL, "imageUrl" varchar NOT NULL, "isCoverImage" boolean NOT NULL, "announcementId" varchar, CONSTRAINT "FK_fac6198a89ec23116ca0352104d" FOREIGN KEY ("announcementId") REFERENCES "announcement" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_announcement" ("id" varchar PRIMARY KEY NOT NULL, "mileage" integer NOT NULL, "color" varchar(50) NOT NULL, "FIPE_priceTable" integer NOT NULL, "price" integer NOT NULL, "isActive" boolean NOT NULL DEFAULT (1), "isSuperBuy" boolean NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, "brandId" varchar, "modelId" varchar, "yearId" varchar, "fuelId" varchar, CONSTRAINT "FK_fd25dfe3da37df1715f11ba6ec8" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_93c7ed7fdd1ad11eff1214471c3" FOREIGN KEY ("brandId") REFERENCES "brands" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_338dba18c0d48c660b1ce98ce75" FOREIGN KEY ("modelId") REFERENCES "models" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_f865a84ff8852eb762c261e989f" FOREIGN KEY ("yearId") REFERENCES "years" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_691de606953492ac88b5d8b5c80" FOREIGN KEY ("fuelId") REFERENCES "fuels" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(100) NOT NULL, "email" varchar(100) NOT NULL, "password" varchar(100) NOT NULL, "reset_token" varchar, "cpf" varchar(11) NOT NULL, "cellPhone" varchar(12) NOT NULL, "birthday" varchar(8) NOT NULL, "description" varchar(255), "is_advertiser" boolean NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "addressId" varchar, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"))`);
        await queryRunner.query(`INSERT INTO "users"("id", "name", "email", "password", "reset_token", "cpf", "cellPhone", "birthday", "description", "is_advertiser", "createdAt", "updatedAt", "addressId") SELECT "id", "name", "email", "password", "reset_token", "cpf", "cellPhone", "birthday", "description", "is_advertiser", "createdAt", "updatedAt", "addressId" FROM "temporary_users"`);
