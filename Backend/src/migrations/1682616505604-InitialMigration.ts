...
export class InitialMigration1682616505604 implements MigrationInterface {
    name = 'InitialMigration1682616505604'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "password" character varying(100) NOT NULL, "reset_token" character varying, "cpf" character varying(11) NOT NULL, "cellPhone" character varying(12) NOT NULL, "birthday" character varying(8) NOT NULL, "description" character varying(255), "is_advertiser" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "imageUrl" character varying NOT NULL, "isCoverImage" boolean DEFAULT false, "announcementId" uuid, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "announcement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "mileage" integer NOT NULL, "color" character varying(50) NOT NULL, "FIPE_priceTable" integer NOT NULL, "price" integer NOT NULL, "description" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "isSuperBuy" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "brandId" uuid, "modelId" uuid, "yearId" uuid, "fuelId" uuid, CONSTRAINT "PK_e0ef0550174fd1099a308fd18a0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "announcement" ADD CONSTRAINT "FK_93c7ed7fdd1ad11eff1214471c3" FOREIGN KEY ("brandId") REFERENCES "brands"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "announcement" ADD CONSTRAINT "FK_338dba18c0d48c660b1ce98ce75" FOREIGN KEY ("modelId") REFERENCES "models"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "announcement" ADD CONSTRAINT "FK_f865a84ff8852eb762c261e989f" FOREIGN KEY ("yearId") REFERENCES "years"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "announcement" ADD CONSTRAINT "FK_691de606953492ac88b5d8b5c80" FOREIGN KEY ("fuelId") REFERENCES "fuels"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
