...
export const ProductDetail = () => {
  ...
  const commentToEdit = async (commentID: string) => {
    const id = localStorage.getItem("announcement_id");
    const response = await api.get(`announcement/comments/${id}`);
    const allComments = response.data[0].comments;
    const comment = allComments.find((el: any) => el.id === commentID);
                  ...
                  <div className="vehicle-detail">
                    ...
                    {userId ? (
                      <a
                        ...
                        target="_blank"
                        href={`https://wa.me/55${announcement.user.cellPhone}?text=Ol%C3%A1,%20estou%20interessado%20em%20negociar%20o%20carro%20${announcement.model.model}`}
                        rel="noreferrer"
                      >
                        Comprar
                      </a>
                            ...
                            <>
                              ...
                              >
                                <div className="container_modal_items">
                                  ...
                                  <img
                                    src={
                                      announcement.images[selectedImageIndex]
                                        .imageUrl
                                    }
                                    alt=""
                                  />
