        ...
        <Form onSubmit={handleSubmit(createUserAccount)}>
          ...
          <div className="container_items">
            ...
            <InputContainer>
                ...
                <Input placeholder="Digitar senha" type="password" {...register("password", { required: true })}/>
                {errors.password && <ErrorMessage>Campo obrigatório</ErrorMessage>}
            </InputContainer> 

            <InputContainer>
                <Label htmlFor="confirmPassword">Confirmar senha:</Label>
                <Input  placeholder="Digitar senha" type="password" {...register("confirmPassword", { required: true })}/>
